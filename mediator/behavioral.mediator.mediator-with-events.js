// Build a mediator on top of Event class
// PlayerScoredEventArgs is the event where subscribed people is connected, where the event of the mediator is executed(fired).
